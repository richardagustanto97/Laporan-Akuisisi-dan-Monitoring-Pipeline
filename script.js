...
const configMap = {
    ...
    "New Rek Payroll New Mitra": { col1: "Nomor Rekening", type1: "text", col2: "New CIF?", type2: "select", options: ["New CIF","No"], col3: "Nama Mitra", type3: "text", col4: "CIF Mitra", type4: "text" },
    "New Rek Payroll Eksisting Mitra" : { col1: "Nomor Rekening", type1: "text", col2: "New CIF?", type2: "select", options: ["New CIF","No"], col3: "Nama Mitra", type3: "text", col4: "CIF Mitra", type4: "text" },
